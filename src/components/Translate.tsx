...
import { Languages, SectionType } from '../utils/types.d';
import TextArea from './TextArea';
import { useState } from '../hooks/useStore';
import { VOICE_FOR_LANGUAGES, AUTO_LANGUAGE } from '../utils/constants';
        ...
        <div className={styles.container}>
            ...
            <div className={styles.fromLanguageCont}>
                ...
                <button className={styles.deleteButton} onClick={() => setFromText("")}>
                    <svg xmlns="http://www.w3.org/2000/svg" className={styles.deleteIcon} width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
            ...
            <div className={styles.toLanguageCont}>
                ...
                <button
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" className={styles.copyIcon} width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                ...
                <button
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" className={styles.speakIcon} width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
